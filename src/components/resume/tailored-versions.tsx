    ...
    <>
      <div className="border border-[#e8e8e8] rounded-[12px] p-5">
        <div className="flex items-center justify-between mb-4">
          <div>
            <p style={{ fontSize: "13px", fontWeight: 600, color: "#111111" }}>Tailored Versions</p>
            <p style={{ fontSize: "11px", color: "#888888", marginTop: "2px" }}>
              Resume versions optimised for specific job descriptions
            </p>
          </div>
          <span
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: "12px", color: "#aaaaaa", marginTop: "4px", maxWidth: "320px" }}>
              Paste a job description and Claude will rewrite your bullet points to match,
              add missing keywords, and boost your ATS score for that specific role.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2 w-full max-w-xs text-left">
            {[
              "Keyword-optimised bullet rewrites",
              "Missing skills & gaps flagged",
