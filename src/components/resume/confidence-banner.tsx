...
export function ConfidenceBanner({ confidence, flags }: ConfidenceBannerProps) {
  if (confidence === "high") {
    return (
      <div className="p-3 bg-green-50 border border-green-200 text-green-800 text-sm rounded-md dark:bg-green-950/30 dark:border-green-800 dark:text-green-300">
  ...
  if (confidence === "medium") {
    return (
      <div className="p-3 bg-yellow-50 border border-yellow-200 text-yellow-800 text-sm rounded-md dark:bg-yellow-950/30 dark:border-yellow-800 dark:text-yellow-300">
  ...
  return (
    <div className="p-3 bg-red-50 border border-red-200 text-red-800 text-sm rounded-md dark:bg-red-950/30 dark:border-red-800 dark:text-red-300">
      <p className="font-medium mb-1">
